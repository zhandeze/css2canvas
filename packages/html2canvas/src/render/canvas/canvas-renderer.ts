...
import {ExtractedCanvasRenderer, RenderConfigurations} from './extracted-canvas-renderer';
...
export class CanvasRenderer extends ExtractedCanvasRenderer {
  constructor(context: Context, options: RenderConfigurations) {
    super(context, options, createBrowserCanvasRendererEnvironment(document, window.navigator.userAgent));
  }
}
