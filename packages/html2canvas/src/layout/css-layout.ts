...
type LayoutEngine = {
  layoutNodeImpl(node: LayoutNode, parentMaxWidth: number | undefined, parentDirection: LayoutDirection | undefined): void;
...
const layoutEngine: LayoutEngine = (function (): LayoutEngine {
    ...
    function setDimensionFromStyle(node: LayoutNode, axis: FlexDirection): void {
      ...
      var styleDim = node.style[dim[axis]];
    ...
    function setTrailingPosition(node: LayoutNode, child: LayoutNode, axis: FlexDirection): void {
      child.layout[trailing[axis]] = (node.layout[dim[axis]] ?? 0) - (child.layout[dim[axis]] ?? 0) - (child.layout[pos[axis]] ?? 0);
    }
    ...
    function layoutNodeImpl(
      ...
      var /*int*/ i;
      var /*int*/ ii;
      var /*css_node_t**/ child: LayoutNode;
      var /*(c)!css_flex_direction_t*/ /*(java)!int*/ axis;

      var /*css_node_t**/ firstAbsoluteChild: LayoutNode | null = null;
      var /*css_node_t**/ currentAbsoluteChild: LayoutNode | null = null;
      ...
      while (endLine < childCount) {
        ...
        var /*float*/ maxWidth: number | undefined;
