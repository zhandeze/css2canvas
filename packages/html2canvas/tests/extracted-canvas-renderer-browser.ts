...
const renderOriginalAndExtracted = async (rawOptions: string | CompareOptions): Promise<{
...
const serializeBounds = (bounds: Bounds | {left: number; top: number; width: number; height: number}): SerializedBounds => ({
    left: bounds.left,
    top: bounds.top,
    width: bounds.width,
